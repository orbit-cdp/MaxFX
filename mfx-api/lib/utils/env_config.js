...
class EnvConfig {
    ...
    orbit_wasm_rel_path;
    admin;
    constructor(rpc, passphrase, friendbot, blend_wasm_rel_path, comet_wasm_rel_path, token_lockup_rel_path, blend_lockup_rel_path, orbit_wasm_rel_path, admin) {
        this.rpc = rpc;
    ...
    static loadFromFile() {
        ...
        return new EnvConfig(new SorobanRpc.Server(rpc_url, { allowHttp: true }), passphrase, friendbot_url, blend_wasm_rel_path, comet_wasm_rel_path, token_lockup_wasm_rel_path, blend_lockup_wasm_rel_path, orbit_wasm_rel_path, Keypair.fromSecret(admin));
    }
    /**
